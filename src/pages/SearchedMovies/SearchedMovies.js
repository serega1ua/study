...
import {fetchMovies, getMovieDetails, searchMovies} from "../../app/features/moviesReducer";
...
const SearchedMovies = () => {
    ...
    const selectMovie = (movie) => {
        ...
        navigate(`/search/${searchQuery}?movie=${movie.id}`)
    };
    ...
    useEffect(() => {
        dispatch(searchMovies({query: searchQuery, genre: "", sortOrder: currentOrder, sortBy: currentSortBy}));
    }, []);
    return (
        <MainSection>
