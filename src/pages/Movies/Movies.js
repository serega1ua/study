...
import { fetchMovies, getMovieDetails } from "../../app/features/moviesReducer";
import {setMovies} from "../../app/features/moviesReducer";
            ...
            <div className="flex flex-wrap max-w-5xl justify-between m-auto">
              <div className="flex flex-col justify-between items-start">
                <h2 className="text-white text-xl mt-6">
                  <span id="test-span" className="font-bold">{reduxMovies.length}</span> movies
                  found
                </h2>
